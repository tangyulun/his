...
public class CkVo {
	...
	public CkVo(String qxThelibraryId, Date qxThelibraryDate, String qxThelibraryDuixiang, String qxThelibraryPzId,
			String qxThelibraryState, String qxThelibraryType, String qxThelibraryWarehouse) {
		super();
