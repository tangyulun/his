...
<script type="text/javascript">
	$(function(){
		$.get("h_number",function(data){
			$("#financ_menzhenshoufei").textbox('setValue',"MJ"+data.substring(3,data.length-1));
		});
	});
	...
	<div id="win" class="easyui-layout" title="供应商结算" style="width:800px;height:500px"   
        data-options="modal:true,minimizable:false,maximizable:false,collapsible:false, fit : true">  
	      ...
	      <div data-options="regsion:'center'" style="height:450px;margin-top: 50px">  
	      	<form action="" style="width: 100%">
		      <table width="95%" style="margin-left:20px">
		           			<tr height="30">
		           				<td width="250px"><input name="" class="easyui-textbox" id="financ_menzhenshoufei" readonly="readonly" data-options="required:true,label:'收费结算号*' ,labelWidth : 100,width:240,labelAlign:'right'"></td>
		           			...
		           			<tr height="30">
		           				<td width="300px">
		           					 <input style="margin-left: 15px" name="" class="easyui-textbox" data-options="required:true,label:'门诊号'
